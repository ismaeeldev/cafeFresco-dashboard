...
export default function ProfileSection() {
  ...
  const { adminName, adminRole, setAdminName, setAdminRole } = useContext(MainContext);
  ...
  return (
    <>
      <Chip
        ...
        label={<IconSettings color='#000000' stroke={1.5} size="24px" />}
        ref={anchorRef}
        aria-controls={open ? 'menu-list-grow' : undefined}
        aria-haspopup="true"
                  ...
                  <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                    <Box sx={{ p: 2, pb: 0 }}>
                      <Stack>
                        ...
                        <Typography variant="subtitle2">Project {adminRole}</Typography>
                      </Stack>
